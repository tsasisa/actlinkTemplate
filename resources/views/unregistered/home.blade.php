...
@section('content')
    ...
    <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="4000">
        <div class="carousel-inner">
            ...
            <div class="carousel-item" style="background: url('{{ asset('assets/images/2.jpg') }}') no-repeat center center/cover;">
                <section class="hero d-flex align-items-center justify-content-center text-center">
                    <div class="container position-relative text-white">
                        <h1 class="display-4 fw-bold">Be an Action!</h1>
                        <p class="lead">Follow and see our events more. Join the movement for a better future.</p>
    ...
    <section class="sdg-section py-5">
        <div class="container text-center">
            <h4 class="sdg-heading fw-bold mb-4">Our Focus on Sustainable Development Goals</h4>
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                ...
                <div class="col">
                    <div class="sdg-icon-card priority">
                        ...
                        <p class="lead"> This is our top priority, focusing on reforestation, land conservation, and biodiversity protection.</p>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="sdg-icon-card">
                        ...
                        <p class="lead">Good Health and Well-Being - Ensure healthy lives and promote well-being for all at all ages.</p>
                    </div>
                </div>
...
<section class="latest-events py-5 ">
    <div class="container text-center">
        <h4 class="event-heading fw-bold mb-4">Top 3 Latest Events</h4>
        <div class="row">
...
<section class="largest-participants pb-4">
    <div class="container text-center">
        <h4 class="event-heading fw-bold mb-4">Top 3 Events with Largest Participants</h4>
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="event-card p-4 mb-4">
                    ...
                    <p class="event-date">{{ \Carbon\Carbon::parse($event->eventDate)->format('d M, Y') }}</p>
                    <p class="event-location">{{ $event->eventLocation }}</p>
                    <p class="event-participants">Participants: {{ $event->eventParticipantNumber }} / {{ $event->eventParticipantQuota }}</p>
                    <p class="event-organizer">Organized by: {{ $event->organizer->user->userName }}</p>
                </div>
            </div>
            @endforeach
